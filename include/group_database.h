...
#ifndef __GROUP_DATABASE_H
#define __GROUP_DATABASE_H
...
namespace Tomb
{
	...
	// Fills the database with info from the files
	void database_fill()
	{
		try
	...
	// Flush the database into json files
	void database_flush()
	{
		try
		{
